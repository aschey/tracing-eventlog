...
pub mod platform {
    ...
    impl LogSource {
        ...
        pub fn custom<'a>(
            ...
            sources: impl Into<Option<Vec<&'a str>>>,
        ) -> Self {
            let name = name.into();
        ...
        pub fn register(&self) -> core::result::Result<(), RegistryError> {
        ...
        pub fn deregister(name: impl AsRef<str>) -> core::result::Result<(), RegistryError> {
